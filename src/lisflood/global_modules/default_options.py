...
default_options = {'EnKF': False,
                   ...
                   'reportedmaps': {'AreaTotalAbstractionFromSurfaceWaterM3': ReportedMap(
                       ...
                       'WetlandLevelEnd': ReportedMap(name='WetlandLevelEnd', output_var='WetlandLevel',
                                                   unit='m', end=['repEndMaps'], steps=[], all=[],
                                                   restrictoption=['nonInit', 'simulateWetlands'],
                                                   monthly=False, yearly=False),
                       'WetlandLevelState': ReportedMap(name='WetlandLevelState', output_var='WetlandLevel',
                                                     unit='m', end=[], steps=['repStateMaps'],
                                                     all=[],
                                                     restrictoption=['nonInit', 'simulateWetlands'],
                                                     monthly=False, yearly=False),

                       'WetlandPrevInflowEnd': ReportedMap(name='WetlandPrevInflowEnd', output_var='WetlandInflowOld',
                                                   unit='m3/s', end=['repEndMaps'], steps=[], all=[],
                                                   restrictoption=['nonInit', 'simulateWetlands'],
                                                   monthly=False, yearly=False),
                       'WetlandPrevInflowState': ReportedMap(name='WetlandPrevInflowState', output_var='WetlandInflowOld',
                                                     unit='m3/s', end=[], steps=['repStateMaps'],
                                                     all=[],
                                                     restrictoption=['nonInit', 'simulateWetlands'],
                                                     monthly=False, yearly=False),
                       'WetlandPrevOutflowEnd': ReportedMap(name='WetlandPrevOutflowEnd', output_var='WetlandOutflow',
                                                        unit='m3/s', end=['repEndMaps'], steps=[], all=[],
                                                        restrictoption=['nonInit', 'simulateWetlands'],
                                                        monthly=False, yearly=False),
                       'WetlandPrevOutflowState': ReportedMap(name='WetlandPrevOutflowState', output_var='WetlandOutflow',
                                                          unit='m3/s', end=[], steps=['repStateMaps'],
                                                          all=[],
                                                          restrictoption=['nonInit', 'simulateWetlands'],
                                                          monthly=False, yearly=False),
                       'WetlandStorageM3': ReportedMap(name='WetlandStorageM3', output_var='WetlandStorageM3',
                                                    unit='m3', end=[], steps=['repTotalAbs'],
                                                    all=[], restrictoption=['nonInit', 'wateruse',
                                                                            'simulateWetlands'],
                                                    monthly=False, yearly=False),
                   ...
                   'timeseries': {
                       ...
                       'WetlandInflowTS': TimeSeries(name='WetlandInflowTS', output_var='WetlandInflowM3S',
                                                  where='WetlandSites', repoption=['repsimulateWetlands'],
                                                  restrictoption=['nonInit', 'simulateWetlands'], operation=['']),
                       'WetlandLevelTS': TimeSeries(name='WetlandLevelTS', output_var='WetlandLevel', where='WetlandSites',
                                                 repoption=['repsimulateWetlands'],
                                                 restrictoption=['nonInit', 'simulateWetlands'], operation=['']),
                       'WetlandOutflowTS': TimeSeries(name='WetlandOutflowTS', output_var='WetlandOutflowM3S',
                                                   where='WetlandSites', repoption=['repsimulateWetlands'],
                                                   restrictoption=['nonInit', 'simulateWetlands'], operation=['']),                                                   
